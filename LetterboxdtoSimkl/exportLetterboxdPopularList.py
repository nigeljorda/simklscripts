...
def extract_tmdb_info(movie_url):
    try:
        ...
        if tmdb_button:
            ...
            # Check if it's a movie or show based on the link
        ...
        return movie_url, tmdb_link, media_type
...
with ThreadPoolExecutor(max_workers=10) as executor:
    ...
    for future in as_completed(future_to_movie):
        movie_url, tmdb_link, media_type = future.result()
...
csv_header = ["Position", "Letterboxd URL", "TMDB Link", "Type"]
